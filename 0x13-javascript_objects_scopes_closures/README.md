...
chmod u+x 0-rectangle.js && git add --chmod=+x 9-rectangle.py && git commit -m 'Task 00  an empty class Rectangle that defines a rectangle: 9-rectangle.py' && git push
