...
chmod u+x 10-converter.js && git add --chmod=+x 10-converter.js && git commit -m 'Task 10 a function that converts a number from base 10 to another base passed as argument: 10-converter.js' && git push
