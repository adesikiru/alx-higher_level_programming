...
chmod u+x 3-rectangle.js && git add --chmod=+x 3-rectangle.js && git commit -m 'Task 02 a class Rectangle that defines a rectangle: 3-rectangle.js' && git push

touch 3-rectangle.js && git add . && git commit -m 3-rectangle.js
