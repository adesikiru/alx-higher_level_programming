...
chmod u+x 100-map.js && git add --chmod=+x 100-map.js && git commit -m 'Advanced Task 100 a script that imports an array and computes a new array. 100-map.js' && git push
