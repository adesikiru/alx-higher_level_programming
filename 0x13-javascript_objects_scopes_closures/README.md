...
chmod u+x 0-rectangle.js && git add --chmod=+x 9-rectangle.py && git commit -m 'Task 09 a class Rectangle that defines a rectangle by: (based on 8-rectangle.py) 9-rectangle.py' && git push
