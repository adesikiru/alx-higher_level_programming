...
chmod u+x 0-square.py && git add --chmod=+x 0-square.py && git commit -m 'Task 01 a class Square that defines a square by: (based on 0-square.py) 0-square.py' && git push
