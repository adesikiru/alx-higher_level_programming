...
chmod u+x 0-square.py && git add --chmod=+x 0-square.py && git commit -m 'Task 00 tCreate three C functions that print some basic info about Python lists, Python bytes an Python float objects. 0-square.py' && git push
