...
chmod u+x 101-post_json.sh && git add --chmod=+x 101-post_json.sh && git commit -m 'Advanced Task 101 a script that lists all City objects from the database hbtn_0e_101_usa 101-post_json.sh' && git push
