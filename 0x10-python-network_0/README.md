...
chmod u+x 0-hbtn_status.py && git add --chmod=+x 0-hbtn_status.py && git commit -m 'Task 00 a function that finds a peak in a list of unsorted integers. 0-hbtn_status.py' && git push
