...
chmod u+x 2-delete.sh && git add --chmod=+x 2-delete.sh && git commit -m 'Task 01 a Bash script that takes in a URL, sends a GET request to the URL, and displays the body of the response 2-delete.sh' && git push
