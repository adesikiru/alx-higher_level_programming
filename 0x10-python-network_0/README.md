...
chmod u+x 1-body.sh && git add --chmod=+x 1-body.sh && git commit -m 'Task 01 a Bash script that takes in a URL, sends a GET request to the URL, and displays the body of the response 1-body.sh' && git push
