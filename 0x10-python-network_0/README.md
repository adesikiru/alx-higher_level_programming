...
chmod u+x 6-post_email.py && git add --chmod=+x 6-post_email.py && git commit -m 'Task 06 POST an email #1 6-post_email.py' && git push

touch 6-post_email.py && git add . && git commit -m 6-post_email.py
