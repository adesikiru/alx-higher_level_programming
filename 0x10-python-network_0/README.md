...
chmod u+x 3-methods.sh && git add --chmod=+x 3-methods.sh && git commit -m 'Task 03a Bash script that takes in a URL and displays all HTTP methods the server will accept. 3-methods.sh' && git push
