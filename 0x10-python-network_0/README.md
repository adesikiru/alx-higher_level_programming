...
chmod u+x 2-post_email.py && git add --chmod=+x 2-post_email.py && git commit -m 'Task 02 POST an email #0 2-post_email.py' && git push

touch 2-post_email.py && git add . && git commit -m 2-post_email.py
