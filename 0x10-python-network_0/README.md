...
chmod u+x 0-body_size.sh && git add --chmod=+x 0-body_size.sh && git commit -m 'Task 14 a Python file similar to model_state.py named model_city.py that contains the class definition of a City. 0-body_size.sh' && git push
