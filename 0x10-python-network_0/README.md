...
chmod u+x 1-hbtn_header.py && git add --chmod=+x 1-hbtn_header.py && git commit -m 'Task 01 a Python script that fetches 1-hbtn_header.py' && git push

touch 1-hbtn_header.py && git add . && git commit -m 1-hbtn_header.py
