...
chmod u+x 4-header.sh && git add --chmod=+x 4-header.sh && git commit -m 'Task 04 a Bash script that takes in a URL and displays all HTTP methods the server will accept. 4-header.sh' && git push
