...
chmod u+x 101-post_json.sh && git add --chmod=+x 101-post_json.sh && git commit -m 'Advanced Task 101 a Bash script that sends a JSON POST request to a URL passed as the first argument, and displays the body of the response 101-post_json.sh' && git push
...
touch 101-post_json.sh && git add . && git commit -m 101-post_json.sh
