...
chmod u+x 0-javascript_is_amazing.js && git add --chmod=+x 0-javascript_is_amazing.js && git commit -m 'Task 00 a function that prints the number of arguments already printed and the new argument value. 0-javascript_is_amazing.js' && git push
