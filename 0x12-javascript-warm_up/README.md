...
chmod u+x 11-second_biggest.js && git add --chmod=+x 11-second_biggest.js && git commit -m 'Task 10 a script that computes and prints a factorial 11-second_biggest.js' && git push
