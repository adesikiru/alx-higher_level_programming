...
chmod u+x 6-multi_languages_loop.js && git add --chmod=+x 6-multi_languages_loop.js && git commit -m 'Task 06 a script that prints 3 lines: (like 1-multi_languages.js) but by using an array of string and a loop 6-multi_languages_loop.js' && git push
