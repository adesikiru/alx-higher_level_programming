...
chmod u+x 1-multi_languages.js && git add --chmod=+x 1-multi_languages.js && git commit -m 'Task 01 a script that prints a message depending of the number of arguments passed: 1-multi_languages.js' && git push
