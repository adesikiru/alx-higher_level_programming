...
chmod u+x 8-square.js && git add --chmod=+x 8-square.js && git commit -m 'Task 08 a script that prints a square 8-square.js' && git push

touch 8-square.js && git add . && git commit -m 8-square.js
