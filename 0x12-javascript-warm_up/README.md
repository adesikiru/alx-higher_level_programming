...
chmod u+x 2-arguments.js && git add --chmod=+x 2-arguments.js && git commit -m 'Task 02 a script that prints a message depending of the number of arguments passed: 2-arguments.js' && git push

touch 2-arguments.js && git add . && git commit -m 2-arguments.js
