...
chmod u+x 5-to_integer.js && git add --chmod=+x 5-to_integer.js && git commit -m 'Task 05 a script that prints My number: <first argument converted in integer> if the first argument can be converted to an integer: 5-to_integer.js' && git push

touch 5-to_integer.js && git add . && git commit -m 5-to_integer.js
