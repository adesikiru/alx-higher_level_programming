...
chmod u+x 3-value_argument.js && git add --chmod=+x 3-value_argument.js && git commit -m 'Task 02 a script that prints a message depending of the number of arguments passed: 3-value_argument.js' && git push
