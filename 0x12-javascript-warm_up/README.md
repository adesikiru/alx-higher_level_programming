...
chmod u+x 9-add.js && git add --chmod=+x 9-add.js && git commit -m 'Task 08 a script that prints the addition of 2 integers 9-add.js' && git push

touch 9-add.js && git add . && git commit -m 9-add.js
