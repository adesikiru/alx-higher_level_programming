...
chmod u+x 6-multi_languages_loop.js && git add --chmod=+x 6-multi_languages_loop.js && git commit -m 'Task 06 a script that prints My number: <first argument converted in integer> if the first argument can be converted to an integer: 6-multi_languages_loop.js' && git push
