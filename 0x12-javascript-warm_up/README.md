...
chmod u+x 103-object_fct.js && git add --chmod=+x 103-object_fct.js && git commit -m 'Advanced Task 103 a function that increments and calls a function. 103-object_fct.js' && git push
