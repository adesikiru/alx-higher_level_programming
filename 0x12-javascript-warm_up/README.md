...
chmod u+x 3-value_argument.js && git add --chmod=+x 3-value_argument.js && git commit -m 'Task 04 a script that prints two arguments passed to it, in the following format: “ is ” 3-value_argument.js' && git push

touch 3-value_argument.js && git add . && git commit -m 3-value_argument.js
