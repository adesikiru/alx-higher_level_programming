...
chmod u+x 7-multi_c.js && git add --chmod=+x 7-multi_c.js && git commit -m 'Task 07 a script that prints x times “C is fun” 7-multi_c.js' && git push

touch 7-multi_c.js && git add . && git commit -m 7-multi_c.js
