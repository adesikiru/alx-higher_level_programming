...
chmod u+x 1-multi_languages.js && git add --chmod=+x 1-multi_languages.js && git commit -m 'Task 00 a script that prints “JavaScript is amazing”: 1-multi_languages.js' && git push
