...
chmod u+x 10-factorial.js && git add --chmod=+x 10-factorial.js && git commit -m 'Task 09 a script that computes and prints a factorial 10-factorial.js' && git push

touch 10-factorial.js && git add . && git commit -m 10-factorial.js
