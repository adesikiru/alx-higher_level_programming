...
chmod u+x 0-add_integer.txt && git add --chmod=+x 0-add_integer.txt && git commit -m 'Task 01 a function that divides all elements of a matrix. 2-matrix_divided.py' && git push
