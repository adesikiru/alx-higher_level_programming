...
chmod u+x 100-safe_print_integer_err.py && git add --chmod=+x 100-safe_print_integer_err.py && git commit -m 'Task 07 a function that prints an integer. 100-safe_print_integer_err.py' && git push
