...
chmod u+x 4-list_division.py && git add --chmod=+x 4-list_division.py && git commit -m 'Task 04 a function that divides element by element 2 lists. 4-list_division.py' && git push
