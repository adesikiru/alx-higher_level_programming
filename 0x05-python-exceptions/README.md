...
chmod u+x 4-list_division.py && git add --chmod=+x 4-list_division.py && git commit -m 'Task 04 a function that raises a type exception. 4-list_division.py' && git push
