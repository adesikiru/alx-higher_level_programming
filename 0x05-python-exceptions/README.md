...
chmod u+x 101-safe_function.py && git add --chmod=+x 101-safe_function.py && git commit -m 'Advanced Task 08 a function that executes a function safely. 101-safe_function.py' && git push
