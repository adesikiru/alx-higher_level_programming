...
chmod u+x 2-safe_print_list_integers.py && git add --chmod=+x 2-safe_print_list_integers.py && git commit -m 'Task 03  a function that divides 2 integers and prints the result. 2-safe_print_list_integers.py' && git push
