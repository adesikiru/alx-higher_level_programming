...
chmod u+x 1-safe_print_integer.py && git add --chmod=+x 1-safe_print_integer.py && git commit -m 'Task 02 a function that prints the first x elements of a list and only integers. 1-safe_print_integer.py' && git push
