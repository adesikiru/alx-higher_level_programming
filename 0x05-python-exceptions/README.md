...
chmod u+x 3-safe_print_division.py && git add --chmod=+x 3-safe_print_division.py && git commit -m 'Task 03 a function that divides element by element 2 lists. 3-safe_print_division.py' && git push
