...
chmod u+x 6-raise_exception_msg.py && git add --chmod=+x 6-raise_exception_msg.py && git commit -m 'Task 06 a function that raises a name exception with a message. 6-raise_exception_msg.py' && git push
