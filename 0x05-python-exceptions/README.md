...
chmod u+x 1-safe_print_integer.py && git add --chmod=+x 1-safe_print_integer.py && git commit -m 'Task 01 a function that prints an integer with "{:d}".format(). 1-safe_print_integer.py' && git push
