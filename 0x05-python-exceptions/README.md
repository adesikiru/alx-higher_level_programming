...
chmod u+x 100-safe_print_integer_err.py && git add --chmod=+x 100-safe_print_integer_err.py && git commit -m 'Advanced Task 08 a function that executes a function safely. 100-safe_print_integer_err.py' && git push
