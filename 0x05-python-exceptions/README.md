...
chmod u+x 0-safe_print_list.py && git add --chmod=+x 0-safe_print_list.py && git commit -m 'Task 00  a function that prints x elements of a list.  0-safe_print_list.py' && git push
