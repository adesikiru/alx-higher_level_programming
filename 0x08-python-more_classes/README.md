...
chmod u+x 2-rectangle.py && git add --chmod=+x 2-rectangle.py && git commit -m 'Task 02  a class Rectangle that defines a rectangle by: (based on 1-rectangle.py) 2-rectangle.py' && git push
