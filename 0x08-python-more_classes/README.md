...
chmod u+x 8-rectangle.py && git add --chmod=+x 8-rectangle.py && git commit -m 'Task 07 a class Rectangle that defines a rectangle by: (based on 6-rectangle.py) 8-rectangle.py' && git push
