...
chmod u+x 4-rectangle.py && git add --chmod=+x 4-rectangle.py && git commit -m 'Task 03 a class Rectangle that defines a rectangle by: (based on 3-rectangle.py) 4-rectangle.py' && git push
