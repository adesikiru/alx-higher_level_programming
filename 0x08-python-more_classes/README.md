...
chmod u+x 9-rectangle.py && git add --chmod=+x 9-rectangle.py && git commit -m 'Task 09 a class Rectangle that defines a rectangle by: (based on 7-rectangle.py) 9-rectangle.py' && git push
