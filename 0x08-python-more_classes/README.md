...
chmod u+x 3-rectangle.py && git add --chmod=+x 3-rectangle.py && git commit -m 'Task 03 a class Rectangle that defines a rectangle by: (based on 3-rectangle.py) 3-rectangle.py' && git push

touch 3-rectangle.py && git add . && git commit -m 3-rectangle.py
