...
chmod u+x 1-rectangle.py && git add --chmod=+x 1-rectangle.py && git commit -m 'Task 01 an empty class Rectangle that defines a rectangle: 1-rectangle.py' && git push
