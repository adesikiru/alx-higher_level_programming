...
chmod u+x 5-rectangle.py && git add --chmod=+x 5-rectangle.py && git commit -m 'Task 04  a class Rectangle that defines a rectangle by: (based on 3-rectangle.py) 5-rectangle.py' && git push
