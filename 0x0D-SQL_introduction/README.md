...
chmod u+x 101-lazy_matrix_mul.py && git add --chmod=+x 101-lazy_matrix_mul.py && git commit -m 'Advanced Task 100 -- Converts the entire database hbtn_0c_0 to UTF8. 101-lazy_matrix_mul.py ' && git push
