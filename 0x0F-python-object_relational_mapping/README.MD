...
chmod u+x 3-my_safe_filter_states.py && git add --chmod=+x 3-my_safe_filter_states.py && git commit -m 'Task 03 a script that takes in an argument and displays all values in the states table of hbtn_0e_0_usa where name matches the argument. 3-my_safe_filter_states.py' && git push
