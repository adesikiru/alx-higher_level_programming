...
chmod u+x 0-select_states.py && git add --chmod=+x 0-select_states.py && git commit -m 'Task 00  a script that lists all states from the database hbtn_0e_0_usa: 0-select_states.py' && git push
