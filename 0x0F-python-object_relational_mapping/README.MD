...
chmod u+x 1-filter_states.py && git add --chmod=+x 1-filter_states.py && git commit -m 'Task 01  a script that lists all states from the database hbtn_0e_0_usa: 1-filter_states.py' && git push
