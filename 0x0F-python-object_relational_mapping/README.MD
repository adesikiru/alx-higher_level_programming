...
chmod u+x model_state.py && git add --chmod=+x model_state.py && git commit -m 'header file model_state.py' && git push
...
chmod u+x model_state.py && git add --chmod=+x model_state.py && git commit -m 'Task 00  a script that lists all states from the database hbtn_0e_0_usa: model_state.py' && git push

touch model_state.py && git add . && git commit -m model_state.py
