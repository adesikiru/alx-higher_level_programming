...
chmod u+x 7-model_state_fetch_all.py && git add --chmod=+x 7-model_state_fetch_all.py && git commit -m 'Task 07 a script that lists all State objects from the database hbtn_0e_6_usa 7-model_state_fetch_all.py' && git push
