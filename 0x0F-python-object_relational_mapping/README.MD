...
chmod u+x 0-select_states.py && git add --chmod=+x 0-select_states.py && git commit -m 'Task 00 a file that modifies the value of myVar to 333 0-select_states.py' && git push
