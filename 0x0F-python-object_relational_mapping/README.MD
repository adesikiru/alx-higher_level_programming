...
chmod u+x 5-filter_cities.py && git add --chmod=+x 5-filter_cities.py && git commit -m 'Task 04 a script that lists all cities from the database hbtn_0e_4_usa 5-filter_cities.py' && git push
