...
chmod u+x 4-cities_by_state.py && git add --chmod=+x 4-cities_by_state.py && git commit -m 'Task 04 a script that lists all cities from the database hbtn_0e_4_usa 4-cities_by_state.py' && git push
