...
chmod u+x 5-unique_id.sql && git add --chmod=+x 5-unique_id.sql && git commit -m 'Task 05 -- creates the table unique_id on your MySQL server 5-unique_id.sql'

 && git push

touch 5-unique_id.sql && git add . && git commit -m 5-unique_id.sql
