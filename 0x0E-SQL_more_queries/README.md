...
chmod u+x 102-rating_shows.sql && git add --chmod=+x 102-rating_shows.sql && git commit -m 'Advanced Task 102 -- lists all shows from hbtn_0d_tvshows_rate by their rating 102-rating_shows.sql'
