...
chmod u+x 6-states.sql && git add --chmod=+x 6-states.sql && git commit -m 'Task 07 -- creates the database hbtn_0d_usa and the table cities (in the database hbtn_0d_usa) on your MySQL server 6-states.sql'
