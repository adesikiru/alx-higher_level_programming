...
chmod u+x 10-genre_id_by_show.sql && git add --chmod=+x 10-genre_id_by_show.sql && git commit -m 'Task 10 -- lists all shows contained in the database hbtn_0d_tvshows 10-genre_id_by_show.sql'
