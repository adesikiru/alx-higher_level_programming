...
chmod u+x 101-not_a_comedy.sql && git add --chmod=+x 101-not_a_comedy.sql && git commit -m 'Advanced Task 102 -- lists all shows from hbtn_0d_tvshows_rate by their rating 101-not_a_comedy.sql'
