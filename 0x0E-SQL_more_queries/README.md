...
chmod u+x 4-never_empty.sql && git add --chmod=+x 4-never_empty.sql && git commit -m 'Task 05 -- creates the table unique_id on your MySQL server 4-never_empty.sql'

 && git push

touch 4-never_empty.sql && git add . && git commit -m 4-never_empty.sql
