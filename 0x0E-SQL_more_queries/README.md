...
chmod u+x 0-privileges.sql && git add --chmod=+x 0-privileges.sql && git commit -m 'Task 00 -- Lists all records of the table second_table having a name value in my MySQL server. 0-privileges.sql' && git push

touch 0-privileges.sql && git add . && git commit -m 0-privileges.sql
