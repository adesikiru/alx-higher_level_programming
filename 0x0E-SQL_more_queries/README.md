...
chmod u+x 2-create_read_user.sql && git add --chmod=+x 2-create_read_user.sql && git commit -m 'Task 03 -- creates the table force_name on your MySQL server 2-create_read_user.sql'
