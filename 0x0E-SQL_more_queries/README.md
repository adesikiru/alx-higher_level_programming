...
chmod u+x 11-genre_id_all_shows.sql && git add --chmod=+x 11-genre_id_all_shows.sql && git commit -m 'Task 11 -- lists all shows contained in the database hbtn_0d_tvshows 11-genre_id_all_shows.sql'
