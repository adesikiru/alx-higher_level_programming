...
chmod u+x 0-privileges.sql && git add --chmod=+x 0-privileges.sql && git commit -m 'Task 00 -- Lists all privileges of the MySQL users user_0d_1 and user_0d_2 0-privileges.sql' && git push
