...
chmod u+x 11-genre_id_all_shows.sql && git add --chmod=+x 11-genre_id_all_shows.sql && git commit -m 'Task 12 -- lists all shows contained in hbtn_0d_tvshows without a genre linked 11-genre_id_all_shows.sql'
