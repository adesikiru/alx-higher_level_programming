...
chmod u+x 12-no_genre.sql && git add --chmod=+x 12-no_genre.sql && git commit -m 'Task 13 -- lists all genres from hbtn_0d_tvshows and displays the number of shows linked to each 12-no_genre.sql'
