...
chmod u+x 9-multiply_by_2.py && git add --chmod=+x 9-multiply_by_2.py && git commit -m 'Task 10 a function that returns a key with the biggest integer value. 9-multiply_by_2.py' && git push
