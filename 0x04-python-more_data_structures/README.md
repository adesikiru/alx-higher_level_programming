...
chmod 2-uniq_add.py && git add --chmod=+x 2-uniq_add.py && git commit -m 'Task 01 a function that replaces all occurrences of an element by another in a new list. 2-uniq_add.py' && git push
