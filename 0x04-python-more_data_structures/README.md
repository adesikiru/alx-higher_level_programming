...
chmod u+x  103-python.c && git add --chmod=+x  103-python.c && git commit -m 'Advanced Task 102 two C functions that print some basic info about Python lists and Python bytes objects. 102-complex_delete.py' && git push
