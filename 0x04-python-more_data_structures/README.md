...
chmod u+x 7-update_dictionary.py && git add --chmod=+x 7-update_dictionary.py && git commit -m 'Task 06 a function that replaces or adds key/value in a dictionary. 7-update_dictionary.py' && git push
