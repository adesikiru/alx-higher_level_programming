...
chmod u+x 0-square_matrix_simple.py   && git add --chmod=+x 0-square_matrix_simple.py   && git commit -m 'Task 00 a C function that prints some basic info about Python lists. 0-square_matrix_simple.py  ' && git push
