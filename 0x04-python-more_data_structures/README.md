...
chmod u+x 2-uniq_add.py && git add --chmod=+x 2-uniq_add.py && git commit -m 'Task 02 a function that returns a set of common elements in two sets. 2-uniq_add.py' && git push
