...
chmod u+x 3-common_elements.py && git add --chmod=+x 3-common_elements.py && git commit -m 'Task 03 a function that returns a set of all elements present in only one set. 3-common_elements.py' && git push
