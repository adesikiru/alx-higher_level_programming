...
chmod u+x 7-update_dictionary.py && git add --chmod=+x 7-update_dictionary.py && git commit -m 'Task 08 a function that deletes a key in a dictionary. 7-update_dictionary.py' && git push
