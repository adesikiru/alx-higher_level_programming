...
chmod 1-search_replace.py && git add --chmod=+x 1-search_replace.py && git commit -m 'Task 01 a function that replaces all occurrences of an element by another in a new list. 1-search_replace.py' && git push
