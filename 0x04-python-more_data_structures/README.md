...
chmod 1-search_replace.py && git add --chmod=+x 0-square_matrix_simple.py   && git commit -m 'Task 01 a function that replaces all occurrences of an element by another in a new list. 0-square_matrix_simple.py  ' && git push
