...
chmod u+x 4-only_diff_elements.py && git add --chmod=+x 4-only_diff_elements.py && git commit -m 'Task 04 a function that returns a set of all elements present in only one set. 4-only_diff_elements.py' && git push
