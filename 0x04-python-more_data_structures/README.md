...
chmod u+x 6-print_sorted_dictionary.py && git add --chmod=+x 6-print_sorted_dictionary.py && git commit -m 'Task 06 a function that replaces or adds key/value in a dictionary. 6-print_sorted_dictionary.py' && git push
