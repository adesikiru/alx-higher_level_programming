...
chmod u+x 6-print_sorted_dictionary.py && git add --chmod=+x 6-print_sorted_dictionary.py && git commit -m 'Task 06 a function that prints a dictionary by ordered keys. 6-print_sorted_dictionary.py' && git push
