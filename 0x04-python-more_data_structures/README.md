...
chmod u+x 5-number_keys.py && git add --chmod=+x 5-number_keys.py && git commit -m 'Task 06 a function that returns the number of keys in a dictionary. 5-number_keys.py' && git push
