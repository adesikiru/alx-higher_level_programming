...
chmod u+x 9-multiply_by_2.py && git add --chmod=+x 9-multiply_by_2.py && git commit -m 'Task 09 a function that returns a new dictionary with all values multiplied by 2 9-multiply_by_2.py' && git push
