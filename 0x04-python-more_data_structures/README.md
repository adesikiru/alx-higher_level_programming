...
chmod u+x 0-square_matrix_simple.py   && git add --chmod=+x 0-square_matrix_simple.py   && git commit -m 'Task 00 a function that computes the square value of all integers of a matrix. 0-square_matrix_simple.py  ' && git push
