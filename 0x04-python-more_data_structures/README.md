...
chmod u+x 102-complex_delete.py   && git add --chmod=+x 101-square_matrix_map.py  && git commit -m 'Advanced Task 102 a function that deletes keys with a specific value in a dictionary. 101-square_matrix_map.py ' && git push
