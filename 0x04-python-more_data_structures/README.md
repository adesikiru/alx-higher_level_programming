...
chmod u+x 10-best_score.py && git add --chmod=+x 10-best_score.py && git commit -m 'Task 11 a function that returns a list with all values multiplied by a number without using any loops. 10-best_score.py' && git push
