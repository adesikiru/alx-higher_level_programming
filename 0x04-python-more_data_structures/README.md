...
chmod 2-uniq_add.py && git add --chmod=+x 2-uniq_add.py && git commit -m 'Task 02 a function that adds all unique integers in a list (only once for each integer). 2-uniq_add.py' && git push
