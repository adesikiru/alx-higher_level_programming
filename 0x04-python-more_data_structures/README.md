...
chmod u+x 8-simple_delete.py && git add --chmod=+x 8-simple_delete.py && git commit -m 'Task 08 a function that returns a new dictionary with all values multiplied by 2 8-simple_delete.py' && git push
