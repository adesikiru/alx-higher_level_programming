...
chmod u+x 100-weight_average.py && git add --chmod=+x 100-weight_average.py && git commit -m 'Advanced Task 101  a function that computes the square value of all integers of a matrix using map 100-weight_average.py' && git push
